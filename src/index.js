  ...
  return (
    <div>
      ...
      <div>
        ...
        <button className="myCustomButton" onClick={() => handleButtonClick('view1')}>View 1</button>
        <button className="myCustomButton" onClick={() => handleButtonClick('view2')}>View 2</button>
        <button className="myCustomButton" onClick={() => handleButtonClick('view3')}>View 3</button>
        <button className="myCustomButton" onClick={() => handleButtonClick('view1')}>View 3</button>
